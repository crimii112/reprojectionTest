...
//     const coord4326 = transform(coord, 'CUSTOM', 'EPSG:4326');
...
//           bucket.forEach(p => {
//             const [lon, lat] = map.getPixelFromCoordinate([p.y, p.x]);
//             const [lont, latt] = map.getPixelFromCoordinate([p.yt, p.xt]);
//             ctx.moveTo(lon, lat);
