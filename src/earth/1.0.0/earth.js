...
(function () {
  ...
  var MAX_PARTICLE_AGE = 100 / 3; // max number of frames a particle is drawn before regeneration   // 입자 수명
  var PARTICLE_LINE_WIDTH = 1.0 / 3; // line width of a drawn particle  // 선 굵기
  var PARTICLE_MULTIPLIER = 7 / 3; // particle count scalar (completely arbitrary--this values looks nice)  // 입자 수 = 화면 크기 * PARTICLE_MULTIPLIER

  var PARTICLE_REDUCTION = 0.75; // reduce particle count to this much of normal for mobile devices
  var FRAME_RATE = 40; // desired milliseconds per frame    // 프레임 간격(40ms)
